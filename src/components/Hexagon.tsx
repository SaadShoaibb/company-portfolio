...
export const Hexagon = (props: ComponentPropsWithoutRef <'svg'>) => {
    ...
    return(
        <svg className={twMerge("text-fuchsia-500/10 -rotate-6", className)} width="82" height="72" viewBox="0 0 82 72" stroke="currentColor" fill="none" strokeWidth="6" xmlns="http://www.w3.org/2000/svg">
