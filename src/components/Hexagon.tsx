...
export const Hexagon = (props: ComponentPropsWithoutRef <'svg'> & {size?: number; reverse?: boolean; duration?: number}) => {
    ...
    return(
        ...
        style={{
         ...
         width="82" height="72" viewBox="0 0 82 72" stroke="currentColor" fill="none" strokeWidth="6" xmlns="http://www.w3.org/2000/svg">
    ...
    {totalPathLength && (
    <motion.svg className={twMerge("text-fuchsia-500/30 -rotate-6 absolute", className)}
    initial={{
        strokeDashoffset: 0
    }}
    animate={{
