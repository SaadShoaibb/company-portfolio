        ...
        <section className="py-60">
            <div className="container">
                <div className="max-w-3xl mx-auto">
                    <h2 className="font-heading font-black text-4xl md:text-5xl lg:text-6xl text-center">Your Portal to every Technological Solution.</h2>
                    <p className="text-xl lg:text-2xl text-center text-zinc-400 mt-8">Keep up with the newest trends, updates, and insights regarding new technology, updated weekly.</p>
                </div>

                <motion.div className="mt-16 md:mt-28 grid grid-cols-1 md:grid-cols-2 gap-8" ref={targetRef}
                style={{
                    marginTop,
                }}>
                    <div className="flex flex-col gap-8">
                        {latestPosts.map(({ data: { title, category, description } }, postIndex) => (
